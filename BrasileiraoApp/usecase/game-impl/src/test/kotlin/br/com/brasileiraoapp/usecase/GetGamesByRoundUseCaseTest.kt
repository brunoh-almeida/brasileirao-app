...
class GetGamesByRoundUseCaseTest {

    private val repository: GameRepository = mockk()
    private val gameResultMapper: GameResponseToGameResultMapper = mockk()

    private val getGameByRoundUseCase: GetGamesByRoundUseCase = GetGamesByRoundUseCaseImpl(
    ...
    fun invoke_shouldReturnSuccess() {
        runBlocking {
            ...
            val actual = getGameByRoundUseCase(3)
    ...
    fun invoke_shouldReturnError() {
        ...
        runBlocking {
            val actual = getGameByRoundUseCase(2)
            assertEquals(expected, actual)
        }
    }
    ...
    private fun prepareScenario(
        ...
        coEvery {
            repository.getGamesByRound(any())
